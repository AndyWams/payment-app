    ...
    <section class="intro_">
        ...
        <div class="decoration">
            ...
            <div class="dec-item" style="display: block;">
                <img src="<?php the_post_thumbnail_url(); ?>" class="dec-image animated fadeInX delay-x1s man_" style="width: 95%;">
                <img src="<?php bloginfo('template_directory') ?>/./assets/img/png/shutter-6-shadow.png" class="dec-shadow  animated fadeIn delay-x2s">
            </div>
            </div>
            </div>
